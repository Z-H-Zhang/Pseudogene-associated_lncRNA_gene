### 二.lncRNA基因注释的全面构建以及假基因相关lncRNA基因的鉴定
##### 1.subreads生成CCS序列
```r
#小鼠
...
```
##### 8.novel genes筛选（筛选出与ref基因没有交集的三代新基因）
```r
...
cat "/home/zhzhang/PG/PseudoPipe_wd/ppipe_input/Homo_sapiens/mysql/Homo_sapiens.GRCh38.108.chr.gtf"|grep -v pseudogene|awk '$1!= "MT" {print $0}' > /home/zhzhang/PG/HPG/GTF_PG/Homo_sapiens.GRCh38.108.chr.rmpg.gtf
...
cat "/home/zhzhang/PG/PseudoPipe_wd/ppipe_input/Oryzias_latipes/mysql/Oryzias_latipes.ASM223467v1.108.chr.gtf"|grep -v pseudogene|awk '$1!= "MT" {print $0}' > "/home/zhzhang/PG/HPG/GTF_PG/Oryzias_latipes.ASM223467v1.108.chr.rmpg.gtf"
...
##### 9.novel lncRNA筛选-筛选不具有蛋白编码能力的转录本
```r
#获取novel  gene的转录本序列
#鸡
...
##### 10.novel lncRNA筛选-筛选不具有pfam蛋白结构域的转录本
```r
...
#青鳉
gffread /home/zhzhang/PG/ISOseqdata/Oryzias_latipes/novel_lnc/Oryzias_latipes.3G_novel_plncgene.gtf -g "/home/zhzhang/PG/refgenome/Oryzias_latipes.ASM223467v1.dna.chr.fa" -w /home/zhzhang/PG/ISOseqdata/Oryzias_latipes/novel_lnc/Oryzias_latipes.3G_novel_plncgene.fa
#鸡
...
#青鳉
transeq /home/zhzhang/PG/ISOseqdata/Oryzias_latipes/novel_lnc/Oryzias_latipes.3G_novel_plncgene.fa /home/zhzhang/PG/ISOseqdata/Oryzias_latipes/novel_lnc/Oryzias_latipes.3G_novel_plncgene.pep.fa -frame=F -clean Y -trim Y
#鸡
...
#青鳉
interproscan.sh -cpu 26 -dp -appl Pfam -dra -f TSV -i /home/zhzhang/PG/ISOseqdata/Oryzias_latipes/novel_lnc/Oryzias_latipes.3G_novel_plncgene.pep.fa -o /home/zhzhang/PG/ISOseqdata/Oryzias_latipes/novel_lnc/Oryzias_latipes.3G_novel_plncgene.ownpfam.tsv
#鸡
...
#青鳉
cat /home/zhzhang/PG/ISOseqdata/Oryzias_latipes/novel_lnc/Oryzias_latipes.3G_novel_plncgene.ownpfam.tsv|awk -F "\t" '$9<1e-5 {print $1}'|awk -F "_" '{print $1}'|sort|uniq > /home/zhzhang/PG/ISOseqdata/Oryzias_latipes/novel_lnc/Oryzias_latipes.3G_novel_plncgene.ownpfam.tid.txt
cat "/home/zhzhang/PG/ISOseqdata/Oryzias_latipes/novel_lnc/Oryzias_latipes.3G_novel_transcripts.transcript_gene_id.txt"|grep -w -Ff /home/zhzhang/PG/ISOseqdata/Oryzias_latipes/novel_lnc/Oryzias_latipes.3G_novel_plncgene.ownpfam.tid.txt|awk '{print $2}'|sort|uniq > /home/zhzhang/PG/ISOseqdata/Oryzias_latipes/novel_lnc/Oryzias_latipes.3G_novel_plncgene.ownpfam.gid.txt
...
#青鳉
cat "/home/zhzhang/PG/ISOseqdata/Oryzias_latipes/novel_lnc/Oryzias_latipes.3G_novel_plncgene.gtf"|grep -w -v -Ff "/home/zhzhang/PG/ISOseqdata/Oryzias_latipes/novel_lnc/Oryzias_latipes.3G_novel_plncgene.ownpfam.gid.txt" > /home/zhzhang/PG/ISOseqdata/Oryzias_latipes/novel_lnc/Oryzias_latipes.3G_novel_lncRNA.gtf

```


##### 11.下载处理基于RNA-seq的lncRNA基因注释，筛选出与Ref-gene以及3代novel-lncRNA没有交集的二代lnc GENE
```r
...
ls /home/zhzhang/PG/lncRNA_class/|grep -v new|grep -v sh|while read i
do
rm /home/zhzhang/PG/lncRNA_class/${i}/${i}.all_lncRNA_exon.merge.bed
done
#由于转录本在liftover后结构问题，鸡的/home/zhzhang/PG/lncRNA_class/Gallus_gallus/Gallus_gallus.all_lncRNA_exon.bed去除：
Chi_XLOC_002103 Chi_TCONS_00005497（整个基因去除）
Chi_XLOC_011441 Chi_TCONS_00032017 （去除转录本）
Chi_XLOC_004651 Chi_TCONS_00011602 （整个基因去除）
Chi_XLOC_036905 Chi_TCONS_00097908（去除转录本）
cat /home/zhzhang/PG/lncRNA_class/Gallus_gallus/Gallus_gallus.all_lncRNA_exon.bed |grep -w -v Chi_XLOC_002103|grep -w -v Chi_TCONS_00032017|grep -w -v Chi_XLOC_004651|grep -w -v Chi_TCONS_00097908 > /home/zhzhang/PG/lncRNA_class/Gallus_gallus/Gallus_gallus.all_lncRNA_exon.ok.bed
rm /home/zhzhang/PG/lncRNA_class/Gallus_gallus/Gallus_gallus.all_lncRNA_exon.bed
mv /home/zhzhang/PG/lncRNA_class/Gallus_gallus/Gallus_gallus.all_lncRNA_exon.ok.bed /home/zhzhang/PG/lncRNA_class/Gallus_gallus/Gallus_gallus.all_lncRNA_exon.bed
#gtf同样去除
cat "/share/home/zhzhang24/PG/RNAseqdata/newGTF/Gallus_gallus.GRCg7b.108.chr.rmpg.novellncRNA.gtf" |grep -w -v Chi_XLOC_002103|grep -w -v Chi_TCONS_00032017|grep -w -v Chi_XLOC_004651|grep -w -v Chi_TCONS_00097908 > "/share/home/zhzhang24/PG/RNAseqdata/newGTF/Gallus_gallus.GRCg7b.108.chr.rmpg.novellncRNA.ok.gtf"
rm "/share/home/zhzhang24/PG/RNAseqdata/newGTF/Gallus_gallus.GRCg7b.108.chr.rmpg.novellncRNA.gtf"
mv "/share/home/zhzhang24/PG/RNAseqdata/newGTF/Gallus_gallus.GRCg7b.108.chr.rmpg.novellncRNA.ok.gtf" "/share/home/zhzhang24/PG/RNAseqdata/newGTF/Gallus_gallus.GRCg7b.108.chr.rmpg.novellncRNA.gtf"
#由于转录本在liftover后结构问题，大鼠的"/home/zhzhang/PG/lncRNA_class/Rattus_norvegicus/Rattus_norvegicus.all_lncRNA_exon.bed"去除：
Rat_XLOC_009000 Rat_TCONS_00021941（去除转录本）
Rat_XLOC_009000 Rat_TCONS_00021942（去除转录本）
Rat_XLOC_032189 Rat_TCONS_00072844（去除转录本）
Rat_XLOC_032189 Rat_TCONS_00072846（去除转录本）
Rat_XLOC_036300 Rat_TCONS_00081817（去除转录本）
Rat_XLOC_036300 Rat_TCONS_00081818
Rat_XLOC_036300 Rat_TCONS_00081819
Rat_XLOC_036300 Rat_TCONS_00081820
Rat_XLOC_036300 Rat_TCONS_00081821
Rat_XLOC_036300 Rat_TCONS_00081822
Rat_XLOC_036300 Rat_TCONS_00081823 
Rat_XLOC_036300 Rat_TCONS_00081824
Rat_XLOC_036300 Rat_TCONS_00081825
Rat_XLOC_039103 Rat_TCONS_00088005（整个基因去除）
Rat_XLOC_022362 Rat_TCONS_00051013（整个基因去除）
Rat_XLOC_031980 Rat_TCONS_00072350（整个基因去除）
cat /home/zhzhang/PG/lncRNA_class/Rattus_norvegicus/Rattus_norvegicus.all_lncRNA_exon.bed |grep -w -v Rat_TCONS_00021941|grep -w -v Rat_TCONS_00021942|grep -w -v Rat_TCONS_00072844|grep -w -v Rat_TCONS_00072846|grep -w -v Rat_TCONS_00081817|grep -w -v Rat_TCONS_00081818|grep -w -v Rat_TCONS_00081819|grep -w -v Rat_TCONS_00081820|grep -w -v Rat_TCONS_00081821|grep -w -v Rat_TCONS_00081822|grep -w -v Rat_TCONS_00081823|grep -w -v Rat_TCONS_00081824|grep -w -v Rat_TCONS_00081825|grep -w -v Rat_XLOC_039103 |grep -w -v Rat_XLOC_022362 |grep -w -v Rat_XLOC_031980 > /home/zhzhang/PG/lncRNA_class/Rattus_norvegicus/Rattus_norvegicus.all_lncRNA_exon.ok.bed
rm /home/zhzhang/PG/lncRNA_class/Rattus_norvegicus/Rattus_norvegicus.all_lncRNA_exon.bed
mv /home/zhzhang/PG/lncRNA_class/Rattus_norvegicus/Rattus_norvegicus.all_lncRNA_exon.ok.bed /home/zhzhang/PG/lncRNA_class/Rattus_norvegicus/Rattus_norvegicus.all_lncRNA_exon.bed
#gtf同样去除
cat "/share/home/zhzhang24/PG/RNAseqdata/newGTF/Rattus_norvegicus.mRatBN7.2.108.chr.rmpg.novellncRNA.gtf" |grep -w -v Rat_TCONS_00021941|grep -w -v Rat_TCONS_00021942|grep -w -v Rat_TCONS_00072844|grep -w -v Rat_TCONS_00072846|grep -w -v Rat_TCONS_00081817|grep -w -v Rat_TCONS_00081818|grep -w -v Rat_TCONS_00081819|grep -w -v Rat_TCONS_00081820|grep -w -v Rat_TCONS_00081821|grep -w -v Rat_TCONS_00081822|grep -w -v Rat_TCONS_00081823|grep -w -v Rat_TCONS_00081824|grep -w -v Rat_TCONS_00081825|grep -w -v Rat_XLOC_039103 |grep -w -v Rat_XLOC_022362 |grep -w -v Rat_XLOC_031980 > "/share/home/zhzhang24/PG/RNAseqdata/newGTF/Rattus_norvegicus.mRatBN7.2.108.chr.rmpg.novellncRNA.ok.gtf"
rm "/share/home/zhzhang24/PG/RNAseqdata/newGTF/Rattus_norvegicus.mRatBN7.2.108.chr.rmpg.novellncRNA.gtf"
mv "/share/home/zhzhang24/PG/RNAseqdata/newGTF/Rattus_norvegicus.mRatBN7.2.108.chr.rmpg.novellncRNA.ok.gtf" "/share/home/zhzhang24/PG/RNAseqdata/newGTF/Rattus_norvegicus.mRatBN7.2.108.chr.rmpg.novellncRNA.gtf"

```
##### 13\. 识别假基因相关的lncRNA基因
```r
#lncRNA基因外显子merge,和假基因交集
ls /home/zhzhang/PG/lncRNA_class/|grep -v new|grep -v sh|while read i
do
echo -e "${i}"
awk '{print $4}' "/home/zhzhang/PG/lncRNA_class/${i}/${i}.all_lncRNA_exon.bed"|sort -u|while read ii
do
strandi=`grep -w "${ii}" /home/zhzhang/PG/lncRNA_class/${i}/${i}.all_lncRNA_exon.bed|awk '{print $6}'|uniq`
grep -w "${ii}" /home/zhzhang/PG/lncRNA_class/${i}/${i}.all_lncRNA_exon.bed|bedtools sort|bedtools merge|awk -v name="${ii}" -v strand="${strandi}" '{print $1"\t"$2"\t"$3"\t"name"\t"$3-$2"\t"strand}' >> /home/zhzhang/PG/lncRNA_class/${i}/${i}.all_lncRNA_exon.merge.bed
done
bedtools intersect -a /home/zhzhang/PG/lncRNA_class/${i}/${i}.all_lncRNA_exon.merge.bed -b /home/zhzhang/PG/PseudoPipe_wd/ppipe_output_blastpro/${i}/pgenes/${i}_hpg.bed -wo > /home/zhzhang/PG/lncRNA_class/${i}/${i}.alllncRNAexonmerge_intersect_pg.bed
done



#lncRNA基因分类，并确定palnc对应的假基因（传至集群服务器/home/zhzhang/PG/lncRNA_class/物种）
#a输入假基因与lncRNA外显子交集文件，b输入lncRNA geneid列表，c输入假基因信息，d输入lncRNA外显子merge.bed
#LncRNA_class输出lnc基因分类信息,LncRNA_pg输出pglnc对应的假基因及其他信息,pgid输出与lncRNA外显子重叠的所有假基因id
lncrnaclass <- function(a,b,c,d,
                        LncRNA_class,LncRNA_pg,pgid){
  #导入lncRNA外显子与假基因交集文件
  ...
  pg_parent <- read.delim(c)%>%
    select(16,17)%>%
    separate(parentgene_id,c("pseudogene_parent"))
  colnames(pg_parent)[1] <- "pgid"
  #计算每个lnc基因外显子总长度
  exonlen <- read.delim(d, header=FALSE)%>%
    dplyr::rename(lncgid=V4)%>%
    group_by(lncgid)%>%
    summarise(total_len=sum(V5))%>%
    data.frame()
  #正义:计算每个lncRNA基因的全部外显子与假基因在相同链上的总重叠长度
  lncRNAPG <- filter(alllncRNAexon_intersect_pg,V6==V12)%>%
    group_by(lncgid,pgid)%>%
    summarise("total_overlap_len"=sum(overlap_len))%>%
    data.frame()%>%
    left_join(exonlen,by="lncgid")%>%
    mutate(pgrate=total_overlap_len*100/total_len,type="Pseudogene-associated sense lncRNA")
  #反义
  anti_lncRNAPG <- filter(alllncRNAexon_intersect_pg,V6!=V12)%>%
    group_by(lncgid,pgid)%>%
    summarise("total_overlap_len"=sum(overlap_len))%>%
    data.frame()%>%
    left_join(exonlen,by="lncgid")%>%
    mutate(pgrate=total_overlap_len*100/total_len,type="Pseudogene-associated antisense lncRNA")
  #获得假基因来源的lncRNA基因的id(1.按照假基因与exon的overlap排名确定与lnc关联的假基因及其类型，2.pgrate相同时优先考虑sense类)
  pgdlncRNAid <- arrange(rbind(lncRNAPG,anti_lncRNAPG),lncgid,desc(pgrate))%>%
    distinct(lncgid,.keep_all = T)
  #两类与pg关联的lnc分别按照total_overlap_len ranking
  PAS_pgdlncRNAid <- filter(pgdlncRNAid,type=="Pseudogene-associated sense lncRNA")%>%
    arrange(desc(total_overlap_len))%>%
    rownames_to_column("rank")%>%
    mutate(rankrate=as.numeric(rank)*100/nrow(filter(pgdlncRNAid,type=="Pseudogene-associated sense lncRNA")))%>%
    mutate(ranktype=case_when(rankrate<=25 ~ "Top 25%",
                              rankrate>25 & rankrate<=50 ~ "Top 25-50%",
                              rankrate>50 & rankrate<=75 ~ "Top 50-75%",
                              rankrate>75 ~ "Bottom 25%"))
  PAA_pgdlncRNAid <- filter(pgdlncRNAid,type=="Pseudogene-associated antisense lncRNA")%>%
    arrange(desc(total_overlap_len))%>%
    rownames_to_column("rank")%>%
    mutate(rankrate=as.numeric(rank)*100/nrow(filter(pgdlncRNAid,type=="Pseudogene-associated antisense lncRNA")))%>%
    mutate(ranktype=case_when(rankrate<=25 ~ "Top 25%",
                              rankrate>25 & rankrate<=50 ~ "Top 25-50%",
                              rankrate>50 & rankrate<=75 ~ "Top 50-75%",
                              rankrate>75 ~ "Bottom 25%"))
  #lncRNA基因分类文件
  lncRNA_class <- left_join(all_lncRNA_geneid,
                            select(pgdlncRNAid,lncgid,type),
                            by="lncgid")
  lncRNA_class$type[is.na(lncRNA_class$type)==T] <- "Non-pseudogene-associated lncRNA"
  colnames(lncRNA_class)[1] <- "geneid"
  #根据假基因-母基因，确定假基因相关的lncRNA基因对应的假基因亲本基因
  pgdlncRNA_PG <- left_join(rbind(PAS_pgdlncRNAid,PAA_pgdlncRNAid),pg_parent,by="pgid")
  #输出lncRNA基因分类文件 he 假基因相关lncRNA基因的信息
  data.table::fwrite(lncRNA_class,file =LncRNA_class,sep = '\t',row.names = F,quote = F,col.names = T)
  data.table::fwrite(pgdlncRNA_PG,file =LncRNA_pg,sep = '\t',row.names = F,quote = F,col.names = T)
}

#鸡
lncrnaclass("~/PG/lncRNA_class/Gallus_gallus.alllncRNAexonmerge_intersect_pg.bed",
            "~/PG/lncRNA_class/Gallus_gallus.all_lncRNA.geneid.txt",
            "~/PG/pg_message/Gallus_gallus_hpg.txt",
            "/home/zhzhang/PG/lncRNA_class/Gallus_gallus.all_lncRNA_exon.merge.bed",
            "/home/zhzhang/PG/lncRNA_class/new_r1/Gallus_gallus.lncRNA_class.txt",
            "/home/zhzhang/PG/lncRNA_class/new_r1/Gallus_gallus.palncRNA_message.txt",
            "/home/zhzhang/PG/lncRNA_class/new_r1/Gallus_gallus.pseudogene_overlap_lnc.id.txt")
#小鼠
lncrnaclass("~/PG/lncRNA_class/Mus_musculus.alllncRNAexonmerge_intersect_pg.bed",
            "~/PG/lncRNA_class/Mus_musculus.all_lncRNA.geneid.txt",
            "~/PG/pg_message/Mus_musculus_hpg.txt",
            "/home/zhzhang/PG/lncRNA_class/Mus_musculus.all_lncRNA_exon.merge.bed",
            ...
            "/home/zhzhang/PG/lncRNA_class/new_r1/Mus_musculus.pseudogene_overlap_lnc.id.txt")
#人
lncrnaclass("~/PG/lncRNA_class/Homo_sapiens.alllncRNAexonmerge_intersect_pg.bed",
            "~/PG/lncRNA_class/Homo_sapiens.all_lncRNA.geneid.txt",
            "~/PG/pg_message/Homo_sapiens_hpg.txt",
            "/home/zhzhang/PG/lncRNA_class/Homo_sapiens.all_lncRNA_exon.merge.bed",
            "/home/zhzhang/PG/lncRNA_class/new_r1/Homo_sapiens.lncRNA_class.txt",
            "/home/zhzhang/PG/lncRNA_class/new_r1/Homo_sapiens.palncRNA_message.txt",
            "/home/zhzhang/PG/lncRNA_class/new_r1/Homo_sapiens.pseudogene_overlap_lnc.id.txt")
#斑马鱼
lncrnaclass("~/PG/lncRNA_class/Danio_rerio.alllncRNAexonmerge_intersect_pg.bed",
            "~/PG/lncRNA_class/Danio_rerio.all_lncRNA.geneid.txt",
            "~/PG/pg_message/Danio_rerio_hpg.txt",
            "/home/zhzhang/PG/lncRNA_class/Danio_rerio.all_lncRNA_exon.merge.bed",
            "/home/zhzhang/PG/lncRNA_class/new_r1/Danio_rerio.lncRNA_class.txt",
            "/home/zhzhang/PG/lncRNA_class/new_r1/Danio_rerio.palncRNA_message.txt",
            "/home/zhzhang/PG/lncRNA_class/new_r1/Danio_rerio.pseudogene_overlap_lnc.id.txt")
#猕猴
lncrnaclass("~/PG/lncRNA_class/Macaca_mulatta.alllncRNAexonmerge_intersect_pg.bed",
            "~/PG/lncRNA_class/Macaca_mulatta.all_lncRNA.geneid.txt",
            "~/PG/pg_message/Macaca_mulatta_hpg.txt",
            "/home/zhzhang/PG/lncRNA_class/Macaca_mulatta.all_lncRNA_exon.merge.bed",
            "/home/zhzhang/PG/lncRNA_class/new_r1/Macaca_mulatta.lncRNA_class.txt",
            "/home/zhzhang/PG/lncRNA_class/new_r1/Macaca_mulatta.palncRNA_message.txt",
            "/home/zhzhang/PG/lncRNA_class/new_r1/Macaca_mulatta.pseudogene_overlap_lnc.id.txt")
#大鼠
lncrnaclass("~/PG/lncRNA_class/Rattus_norvegicus.alllncRNAexonmerge_intersect_pg.bed",
            "~/PG/lncRNA_class/Rattus_norvegicus.all_lncRNA.geneid.txt",
            "~/PG/pg_message/Rattus_norvegicus_hpg.txt",
            "/home/zhzhang/PG/lncRNA_class/Rattus_norvegicus.all_lncRNA_exon.merge.bed",
            "/home/zhzhang/PG/lncRNA_class/new_r1/Rattus_norvegicus.lncRNA_class.txt",
            "/home/zhzhang/PG/lncRNA_class/new_r1/Rattus_norvegicus.palncRNA_message.txt",
            "/home/zhzhang/PG/lncRNA_class/new_r1/Rattus_norvegicus.pseudogene_overlap_lnc.id.txt")
#兔子
lncrnaclass("~/PG/lncRNA_class/Oryctolagus_cuniculus.alllncRNAexonmerge_intersect_pg.bed",
            "~/PG/lncRNA_class/Oryctolagus_cuniculus.all_lncRNA.geneid.txt",
            "~/PG/pg_message/Oryctolagus_cuniculus_hpg.txt",
            "/home/zhzhang/PG/lncRNA_class/Oryctolagus_cuniculus.all_lncRNA_exon.merge.bed",
            "/home/zhzhang/PG/lncRNA_class/new_r1/Oryctolagus_cuniculus.lncRNA_class.txt",
            "/home/zhzhang/PG/lncRNA_class/new_r1/Oryctolagus_cuniculus.palncRNA_message.txt",
            "/home/zhzhang/PG/lncRNA_class/new_r1/Oryctolagus_cuniculus.pseudogene_overlap_lnc.id.txt")
#负鼠
lncrnaclass("~/PG/lncRNA_class/Monodelphis_domestica.alllncRNAexonmerge_intersect_pg.bed",
            "~/PG/lncRNA_class/Monodelphis_domestica.all_lncRNA.geneid.txt",
            "~/PG/pg_message/Monodelphis_domestica_hpg.txt",
            "/home/zhzhang/PG/lncRNA_class/Monodelphis_domestica.all_lncRNA_exon.merge.bed",
            "/home/zhzhang/PG/lncRNA_class/new_r1/Monodelphis_domestica.lncRNA_class.txt",
            "/home/zhzhang/PG/lncRNA_class/new_r1/Monodelphis_domestica.palncRNA_message.txt",
            "/home/zhzhang/PG/lncRNA_class/new_r1/Monodelphis_domestica.pseudogene_overlap_lnc.id.txt")
